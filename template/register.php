...
<tr><td>Login:</td><td><input type="text" name="loginname" class="form-control" value="'. santise($_POST["loginname"]) .'"></td></tr>
<tr><td>Jméno:</td><td><input type="text" name="username" class="form-control" value="'. santise($_POST["username"]) .'"></td></tr>
...
<tr><td>Email:</td><td><input type="text" name="email" class="form-control" value="'. santise($_POST["email"]) .'"></td></tr>'
. $reg_fields .
